...
public class GetStockLevel {
    ...
    public void shouldShowStockForSaltySnacks() {
        ...
        assertEquals(5,overloadedVendingMachine.saltySnack.getStockLevel(),"Should be able to return the number of items in stock for Salty snacks");
    }
    ...
    public void shouldShowStockForChocolate() {
        ...
        assertEquals(10,overloadedVendingMachine.chocolate.getStockLevel(),"Should be able to return the number of items in stock for Salty snacks");
    }
    ...
    public void shouldShowStockForSoftDrinks() {
        ...
        assertEquals(20,overloadedVendingMachine.softDrink.getStockLevel(),"Should be able to return the number of items in stock for Salty snacks");
    }
